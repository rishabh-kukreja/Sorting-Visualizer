...
pygame.font.init()
arial14 = pygame.font.SysFont('Times New Roman', 14)
arial12 = pygame.font.SysFont('Times New Roman', 14)
impact20 = pygame.font.SysFont('Times New Roman', 20)
...
color_green = (75, 229, 0)
color_red = (75, 122, 230)
color_purple = (0, 0, 200)
color_yellow = (255,255,0)

colors = [color_yellow for _ in range(array_size)]
...
def show_off():
    ...
    if vet == vet2:
        for index in range(len(vet)):
            pygame.event.get()
            set_line_color(index, color_yellow)
            slow_down()
        for index in range(len(vet)):
            pygame.event.get()
            if index+1 < len(vet):
    ...
    for i in range(len(vet) - 1, -1, -1):
        for j in range(i):
            ...
            if vet[j] < vet[j + 1]:
                ...
                clear_screen()
                draw_lines()
            set_line_color(j, color_yellow)
            set_line_color(j + 1, color_yellow)
            draw_timer()
    ...
    for i in range(len(vet) - 1, -1, -1):
        ...
        for j in range(i + 1):
            ...
            if vet[j] < vet[max_index] or j == 0:
                set_line_color(max_index, color_yellow)
                max_index = j
...
def quick(array, low, high):
    ...
    for j in range(low, high):
        ...
        if array[j] >= pivot:
            i = i + 1
            set_line_color(i, color_yellow)
            swap_pos(i, j)
        set_line_color(i+1, color_yellow)
        set_line_color(j, color_yellow)
        clear_screen()
        draw_lines()
    swap_pos(i+1, high)
...
def heap_sort(array):
    ...
    while size > 0:
        ...
        swap_pos(0, size)
        slow_down()
        set_line_color(0, color_yellow)
        set_line_color(size, color_yellow)
...
def mark_circle():
    ...
    for num in range(5):  # loop through speed buttons
        if check_distance(mouse_x, mouse_y, int(circle_pos[num][0]), int(circle_pos[num][1])) < 5:
            sort_speed = num
            return num
    for num in range(5):  # loop through array size buttons
...
def draw_buttons():
    if mark_button() == 1:
        ...
        pygame.draw.rect(win, color_yellow, button_pos[1])
    elif mark_button() == 2:
        pygame.draw.rect(win, color_light_blue, button_pos[1])
        pygame.draw.rect(win, color_yellow, button_pos[0])
    else:
        pygame.draw.rect(win, color_yellow, button_pos[0])
        pygame.draw.rect(win, color_yellow, button_pos[1])
